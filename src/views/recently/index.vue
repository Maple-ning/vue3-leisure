...
import { useRecentlyStore } from "@/store/modules/recently";
...
const { recentlyList } = storeToRefs(recentlyStore);
...
<template>
  <div class="app-container recently-container">
    <div class="container-title">最近播放</div>
    <div class="recently-list" ref="tableWrapperRef">
      <el-table
        :data="recentlyList"
